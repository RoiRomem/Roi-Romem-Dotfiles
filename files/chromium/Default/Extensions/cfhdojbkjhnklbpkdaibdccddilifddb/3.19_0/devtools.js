...
var devtools_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
function start() {
    return devtools_awaiter(this, void 0, void 0, function* () {
        const isEnabled = yield prefs.get("show_devtools_panel");
        if (!isEnabled) {
            return;
        }
        const panel = yield browser.devtools.panels.create("Adblock Plus", "icons/abp-32.png", "devtools-panel.html");
