...
;// CONCATENATED MODULE: ../js/content/composer.preload.mjs
/*
...
function startPickingElement()
{
  ...
  front.addDisconnectListener(composer_preload_onDisconnect);
}
...
function deactivateBlockElement(popupAlreadyClosed)
{
  ...
  front.removeDisconnectListener(composer_preload_onDisconnect);
}

function composer_preload_onDisconnect()
{
